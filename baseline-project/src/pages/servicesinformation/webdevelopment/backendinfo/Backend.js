        ...
        <Box maxWidth="xl">
          <Grid container spacing={2} justifyContent="center" alignItems="center" mb={6}>
            <Grid item xs={12}>
              ...
              <Typography variant="body1" align="center" sx={{ fontSize: "20px", fontFamily: "sans-serif", color: "white", mt: 2 }}>
          ...
          <Grid container spacing={2} justifyContent="center" alignItems="center">
            <Grid item xs={12}>
              ...
              {backendTechnologies.map((technology, index) => (
                <Typography key={index} variant="body1" sx={{ fontFamily: "sans-serif", color: "white", mt: 2 }}>
